    ...
    <div className="bg-white">
      <div className="pt-16 pb-12 sm:pt-24 sm:pb-16 md:pt-32 md:pb-9 bg-slate-50 border-b border-slate-200 text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-ink mb-6 tracking-tight leading-tight">
            An enterprise application built natively on Salesforce.
          </h1>
          <p className="text-base sm:text-lg md:text-xl text-slate-500 max-w-3xl mx-auto mb-12 md:mb-20 leading-relaxed">
